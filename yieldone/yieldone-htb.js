...
var PartnerSpecificValidator = require('yieldone-htb-validator.js');
...
function YieldoneHtb(configs) {
    ...
    function __generateRequestObj(returnParcels) {
        ...
        var baseUrl = Browser.getProtocol() + '//y.one.impact-ad.jp/h_bid';
        ...
        queryObj.v = 'hb2';
        queryObj.p = parcel.xSlotRef.placementId;
        queryObj.r = Browser.getPageUrl();
        queryObj.uc = parcel.htSlot.getDivId();
        queryObj.uid = parcel.htSlot.getId();
        queryObj.tid = System.generateUniqueId();
        queryObj.cb = Math.floor(Math.random() * 99999999999);
        queryObj.t = 'i';
        queryObj.sz = parcel.xSlotRef.sizes.map(__formatSize)
            .join(',');
    ...
    */
    ...
    function __parseResponse(sessionId, adResponse, returnParcels) {
        ...
        for (var j = 0; j < returnParcels.length; j++) {
             ...
             */
            var bidCreative = curBid.adTag;

            /* The dealId if applicable for this slot. */
            var bidDealId = curBid.dealId;

            /* Explicitly pass */
            var bidIsPass = bidPrice <= 0 || !curBid.width || !curBid.height;
            ...
            */
            ...
            if (bidIsPass) {
                //? if (DEBUG) {
                Scribe.info(__profile.partnerId + ' returned pass for { id: ' + adResponse.crid + ' }.');
                //? }
                if (__profile.enabledAnalytics.requestTime) {
                    __baseClass._emitStatsEvent(sessionId, 'hs_slot_pass', headerStatsInfo);
                }
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'YieldoneHtb',
            namespace: 'YieldoneHtb',
            statsId: 'YIE',
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
