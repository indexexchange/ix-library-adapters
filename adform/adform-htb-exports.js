 ...
 *  profile name. This function will then be accessible through the window.headertag.AdformHtb object.
...
shellInterface.AdformHtb = {
    render: SpaceCamp.services.RenderService.renderDfpAd.bind(null, 'AdformHtb')
};
//? }
