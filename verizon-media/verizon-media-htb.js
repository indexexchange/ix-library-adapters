...
var PartnerSpecificValidator = require('verizon-media-htb-validator.js');
 ...
 * @class
 */
function VerizonMediaHtb(configs) {
    /* =====================================
     * Data
     * ---------------------------------- */
    ...
    function __generateRequestObj(returnParcels) {
        ...
        // Note: Verizon Media only permit secure requests.
        var BASE_URL = 'https://c2shb.ssp.yahoo.com/bidRequest?';
    ...
    */
    ...
    function __parseResponse(sessionId, adResponse, returnParcels) {
        ...
        var curBid;
        try {
            curBid = adResponse.seatbid[0].bid[0];
        } catch (e) {
            curBid = null;
        }
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'VerizonMediaHtb',
            namespace: 'VerizonMediaHtb',
            statsId: 'VZM',
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
...
module.exports = VerizonMediaHtb;
