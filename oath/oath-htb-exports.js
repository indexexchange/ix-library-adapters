 ...
 *  profile name. This function will then be accessible through the window.headertag.OathHtb object.
...
shellInterface.OathHtb = {
    render: SpaceCamp.services.RenderService.renderDfpAd.bind(null, 'OathHtb')
};
//? }
