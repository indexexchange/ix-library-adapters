...
var PartnerSpecificValidator = require('brightcom-htb-validator.js');
...
function BrightcomHtb(configs) {
    ...
    function __generateRequestObj(returnParcels) {
        ...
        var baseUrl = Browser.getProtocol() + '//brightcombid.marphezis.com/hb?cb=' + System.generateUniqueId();
        var queryObj = {
            id: System.generateUniqueId(),
            imp: returnParcels.map(function (parcel) {
                return {
                    id: parcel.xSlotRef.placementId,
                    banner: {
                        format: parcel.xSlotRef.sizes.map(_formatSize)
                    },
                    tagid: parcel.htSlot.getId(),
    ...
    */
    ...
    function __parseResponse(sessionId, adResponse, returnParcels) {
        ...
        for (var j = 0; j < returnParcels.length; j++) {
            ...
            for (var k = 0; k < bids.length; k++) {
                ...
                if (bids[k].impid === curReturnParcel.xSlotRef.placementId) {
                    curBid = bids[k];
                    bids.splice(k, 1);
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'BrightcomHtb',
            namespace: 'BrightcomHtb',
            statsId: 'BRI',
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
