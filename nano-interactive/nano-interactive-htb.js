...
var PartnerSpecificValidator = require('nano-interactive-htb-validator.js');
 ...
 * @class
 */
function NanoInteractiveHtb(configs) {
    /* =====================================
     * Data
     * ---------------------------------- */
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'NanoInteractiveHtb',
            namespace: 'NanoInteractiveHtb',
            statsId: 'NANO',
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
...
module.exports = NanoInteractiveHtb;
